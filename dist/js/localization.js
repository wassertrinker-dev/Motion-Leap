...
const translations = {
    ...
    de: {
        ...
        finalScore: (score) => `Punkte: ${score}`,
        timeLabel: (minutes, seconds) => `Zeit: ${minutes}:${seconds}`,
        ingameScore: (score) => `Score: ${score}`,
        // Ladebildschirm
        ...
        loadingModel: (p) => `Lade KI-Modell (${p}%)...`,
    ...
    en: {
        ...
        timeLabel: (minutes, seconds) => `Time: ${minutes}:${seconds}`,
        ingameScore: (score) => `Score: ${score}`,
        // Ladebildschirm
    ...
    fr: {
        ...
        finalScore: (score) => `Score : ${score}`,
        timeLabel: (minutes, seconds) => `Temps : ${minutes}:${seconds}`,
        ingameScore: (score) => `Score : ${score}`,
        // Ladebildschirm
        ...
        loadingModel: (p) => `Chargement du modèle IA (${p}%)...`,
    ...
    it: {
        ...
        finalScore: (score) => `Punteggio: ${score}`,
        timeLabel: (minutes, seconds) => `Tempo: ${minutes}:${seconds}`,
        ingameScore: (score) => `Score: ${score}`,
        // Ladebildschirm
        ...
        loadingModel: (p) => `Caricamento del modello AI (${p}%)...`,
    ...
    es: {
        ...
        finalScore: (score) => `Puntuación: ${score}`,
        timeLabel: (minutes, seconds) => `Tiempo: ${minutes}:${seconds}`,
        ingameScore: (score) => `Score: ${score}`,
        // Ladebildschirm
        ...
        loadingModel: (p) => `Cargando modelo de IA (${p}%)...`,
